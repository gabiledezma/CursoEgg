package guia4ejercicio02;

import guia4ejercicio02.entidades.Juego;
import guia4ejercicio02.servicios.ServicioJuego;
...
public class Ejercicio02 {
    ...
    public static void main(String[] args) {
        ...
        de agua, el cual posee una sola carga de agua, se dispara y se moja. Las 
        clases a hacer del juego son las siguientes:
        ...
        (representa el número del jugador), nombre (Empezara con Jugador más su 
        ...
        ser entre 1 y 6. Si no está en este rango, por defecto será 6.
                Métodos:

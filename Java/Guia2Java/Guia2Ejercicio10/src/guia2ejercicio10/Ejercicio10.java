package guia2ejercicio10;

import guia2ejercicio10.Entidades.Funcion;
import guia2ejercicio10.Servicio.ServicioFuncion;
...
public class Ejercicio10 {
    ...
    public static void main(String[] args) {
         ...
         */
        ServicioFuncion sf = new ServicioFuncion();
        Funcion f = sf.rellenarArregloDeFuncion();
        sf.ordenarArreglo(f);
        sf.rellenarArregloSecundario(f);
        sf.mostrarArreglos(f);
        /*
        Funcion f = new Funcion();
        f.rellenarArregloDeFuncion();
        f.ordenarArreglo();
        f.rellenarArregloSecundario();
        f.mostrarArreglos();
         */
    }

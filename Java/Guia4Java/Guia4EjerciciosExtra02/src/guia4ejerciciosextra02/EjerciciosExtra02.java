package guia4ejerciciosextra02;

import guia4ejerciciosextra02.Entidades.Sala;
import guia4ejerciciosextra02.Servicios.ServicioSala;

public class EjerciciosExtra02 {

    public static void main(String[] args) {
        /*
            2. Nos piden hacer un programa sobre un Cine, que tiene una sala con 
        un conjunto de asientos (8 filas por 6 columnas). De Cine nos interesa 
        ...
        del espectador, nos interesa saber su nombre, edad y el dinero que 
        tiene disponible.

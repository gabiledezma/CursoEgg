package guia2ejerciciosextra06;

import guia2ejerciciosextra06.Entidades.Ahorcado;
import guia2ejerciciosextra06.Servicio.ServicioAhorcado;

public class EjerciciosExtra06 {

    public static void main(String[] args) {
        /*
        6. Juego Ahorcado: Crear una clase Ahorcado (como el juego), la cual 
        ...
        realizar el usuario. Definir los siguientes métodos con los parámetros 
        que sean necesarios:
        ...
        del vector. Y también, guarda en cantidad de jugadas máximas, el valor 
        que ingresó el usuario y encontradas en 0.
        ...
        usuario y busca sila letra ingresada es parte de la palabra o no. 
